...
const VERSION = 'TallerSmart Real MVP v11.0.03 · Global Vehicle Platform';
...
const I18N = {
  ...
  en:{workshopLogin:'Workshop Login',clientLogin:'Client Login',workshopSub:'Manage your shop and clients',clientSub:'Your digital garage and vehicles',country:'Country',language:'Language',auto:'Language is preset by country',registerWorkshop:'Register new workshop',registerClient:'Register new client',email:'Email address',password:'Password',enter:'Sign in',back:'Back',createClient:'Create client user',newUser:'Register new user'},
...
function ClientAccount({signOut}){
  ...
  return <main className="client client-session">
    ...
    {screen==='premium'&&<><button className="link" onClick={()=>setScreen('home')}><ArrowLeft/>Volver</button><h2>Cliente PRO</h2><div className="premium-card"><Crown/><h3>Desbloqueá tu garage completo</h3><p>Agregá más de 1 vehículo, alertas avanzadas, historial premium, IA vehicular y futuras funciones pagas.</p><button onClick={()=>alert('Próximo paso: pago de suscripción Cliente PRO con Mercado Pago.')}>Quiero Cliente PRO</button></div></>}
