...
## v11.0.04
- Panel de taller sin accesos repetidos en la página principal.
- Menú del taller con botón Volver al inicio.
- Nuevo cliente y edición de cliente respetan idioma elegido.
- Edición completa de cliente y datos del vehículo.
- Turnos: editar y eliminar turnos asignados.
- Botón temporal Activar PRO Demo para pruebas.

## v11.0.06 - IA Real Demo

Para activar la IA vehicular real en Vercel, agregar estas variables de entorno:

- `OPENAI_API_KEY`: clave privada de OpenAI. No subir a GitHub.
- `OPENAI_MODEL` opcional: por defecto usa `gpt-4o-mini`.

La IA responde orientación inicial y no reemplaza diagnóstico mecánico profesional.
